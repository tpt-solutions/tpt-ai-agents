...
- [x] `tpt-vector-store-pgvector` adapter crate — traits/docs advertise
...
- [ ] `tpt-vector-store-milvus` adapter crate — same gap as pgvector, lower
      priority (more niche deployment; deferred — `milvus-sdk-rust 0.1.0` is
      immature with 35% docs and tonic 0.8)
